 ...
 * 贷方 [住房公积金]
 */
public class PayPersonalHabitationInsAmountTransfer implements VoucherTransfer {
    @Override
    ...
    public String creditGenerator(Extractor extractor) throws Exception {
        if (extractor instanceof SalaryStatementDtlRecordExtractor) {
            ...
            ret = ret.add(record.getHabitationInsPers() != null ? record.getHabitationInsPers() : BigDecimal.ZERO);
